...
import com.wangshu.generate.xml.GenerateXmlPostgres;
import com.wangshu.generate.xml.GenerateXmlSqlServer;
                ...
                if (element instanceof TypeElement temp) {
                    ...
                    if (Objects.nonNull(data)) {
                        ...
                        switch (modelElementInfo.getDataBaseType()) {
                            ...
                            case postgres -> generateXml = new GenerateXmlPostgres<>(modelElementInfo, messageExceptionConsumer);
                            case sqlServer -> generateXml = new GenerateXmlSqlServer<>(modelElementInfo, messageExceptionConsumer);
                        ...
                        if (Objects.nonNull(generateXml)) {
                            ...
                            if (!cn.hutool.core.io.FileUtil.exist(modelElementInfo.getServiceImplFilePath())) {
